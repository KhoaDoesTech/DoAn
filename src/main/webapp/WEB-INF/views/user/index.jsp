	...
	<div class="row">
		<div id="sidebar" class="span3">
				...
				<ul class="nav nav-list">
					...
					<c:forEach var="item" items="${ categorys }">
						<li>
							<a href='<c:url value="/san-pham/${ item.id }"/>'>
								<span class="icon-circle-blank"></span>${ item.name }
							</a>
						</li>
					</c:forEach>
					...
					<li>
						<a class="totalInCart" href="cart.html">
							<strong>Đã mua <span class="badge badge-warning pull-right"
			...
			<div class="well well-small alert alert-warning cntr">
				<h2>50% Discount</h2>
					<p> only valid for online order. <br> <br>
			...
			<ul class="nav nav-list promowrapper">
				...
				<li>
					<div class="thumbnail">
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="#">VIEW</a>
...
-->
	...
	-->
		...
		<hr>
		<div class="well well-small">
			<a class="btn btn-mini pull-right" href="#">Xem thêm
				<span class="icon-plus"></span>
			</a> Tất cả sản phẩm
		</div>
	</div>
