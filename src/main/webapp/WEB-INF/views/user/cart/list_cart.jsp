	...
	<div class="row">
		<div class="span12">
			...
			<div class="well well-small">
				<h1>
					Giỏ hàng <small class="pull-right"> <fmt:formatNumber
				...
				<br /> <a href="/DoAn/" class="shopBtn btn-large"><span
					class="icon-arrow-left"></span> Tiếp tục mua sắm </a> <a
					href="checkout" class="shopBtn btn-large pull-right">Thanh toán
